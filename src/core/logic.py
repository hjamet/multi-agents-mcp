        ...
        while time.time() - start_time < timeout_seconds:
            ...
            if current_turn == agent_name:
                ...
                return {
                    ...
                    "instruction": f"🚨 TURN GRANTED. You MUST run `tail -n 80 CONVERSATION.md` IMMEDIATELY to see what happened while you were waiting. DO NOT SPEAK before reading the history.{advice_text}"
                }
